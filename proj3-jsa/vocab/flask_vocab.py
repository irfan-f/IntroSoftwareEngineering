...
def doit():
    """
    Get the text from #attempt after a keyup (from vocab.html)
    Check various parameters using provided functions
    Return these parameters in JSON object
    Is listened for in vocab.html
    """
    app.logger.debug("Got a JSON request, Checking text")
    ...
    rslt = {"is_match": matched, "word": text, "matches": matches, 
            "in_jumble": in_jumble, "len_j": j_len, "target": target}
